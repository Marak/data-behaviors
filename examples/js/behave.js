...
behave.chart.bar = function(options){options.series = eval($(options.selector).attr('data-resource')).series;
...
behave.machine = function(options){// machine turns elements into state machines
